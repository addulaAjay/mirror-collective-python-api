...
class CognitoService:
    ...
    def _handle_cognito_error(self, error: ClientError, operation: str) -> None:
        ...
        error_mappings = {
            ...
            'ExpiredCodeException': ValidationError(
                ...
                [{"field": "verificationCode", "message": "Verification code has expired"}]
            ),
        ...
        if error_code in error_mappings:
            ...
            raise CognitoServiceError(f"Cognito operation failed: {error_message}", error_code)
    
    async def sign_up_user(self, email: str, password: str, first_name: str, last_name: str) -> Dict[str, Any]:
    ...
    async def authenticate_user(self, email: str, password: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if not all([access_token, refresh_token, id_token]):
                raise AuthenticationError('Authentication failed - incomplete token response')
    ...
    async def refresh_access_token(self, refresh_token: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                'accessToken': access_token,
                'refreshToken': new_refresh_token or refresh_token,  # Use new if provided, otherwise keep old
                'idToken': id_token
            }
    ...
    async def admin_delete_user(self, email: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.exception(f"Unexpected error during admin account deletion: {str(e)}")
