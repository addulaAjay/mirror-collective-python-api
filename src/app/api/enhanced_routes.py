...
async def get_user_conversations(
    ...
    return await controller.get_user_conversations(
        user_id=current_user["sub"], limit=limit, include_archived=include_archived
    )


@enhanced_chat_router.get(
...
async def get_conversation_detail(
    ...
    """
    return await controller.get_conversation_detail(conversation_id, current_user)
