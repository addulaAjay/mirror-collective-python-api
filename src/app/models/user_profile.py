...
class UserProfile:
    ...
    @classmethod
    def from_cognito_user(
        cls, cognito_user_data: Dict[str, Any], user_id: str
    ) -> "UserProfile":
        """
        ...
        return cls(
            ...
            last_cognito_sync=datetime.now(timezone.utc)
            .isoformat()
            .replace("+00:00", "Z"),
        )
